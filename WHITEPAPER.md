...
- A receipt protocol gives the agents *on* the server human-auditable evidence of what they did.
- A registry federates many chapters and checks their badges at admission.

Each is separately useful and separately versioned. `sm-chapter` depends on none of them at runtime — it simply emits the discovery substrate and signed badge that let them compose.
